...
for(i in 1:30) {
  ...
  pst.star.b <- dbeta(p, 0.5 + r, 0.5 + i - r)
...
cat("-- UNIFORM PRIOR \n")
cat("[x1, x2] = [", lower.bond.u[30], ",", upper.bond.u[30], "] \n")
cat("Most probable value =", most.prob.u[30], "\n")
cat("\n")
cat("-- BETA PRIOR \n")
cat("[x1, x2] = [", lower.bond.b[30], ",", upper.bond.b[30], "] \n")
cat("Most probable value =", most.prob.b[30])
